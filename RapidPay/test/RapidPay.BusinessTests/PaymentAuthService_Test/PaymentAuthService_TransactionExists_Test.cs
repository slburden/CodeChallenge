...
public class PaymentAuthService_TransactionExists_Test
{
    ...
    public void Setup()
    {
        ...
        .Returns((string c, decimal a) => Task.FromResult<bool>(true));
    ...
    [TestCase("606481876887782", 7000, false)]
    public async Task Authorize_Payment_Transaction_Test(string cardnum, decimal amount, bool expected)
    {
